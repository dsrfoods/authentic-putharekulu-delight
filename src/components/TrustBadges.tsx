  ...
  return <section className="py-24 bg-slate-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
          {badges.map((badge, index) => <Card key={index} className="group hover:shadow-2xl transition-all duration-500 border-2 border-yellow-400 hover:border-orange-400 bg-slate-800 hover:bg-slate-700 animate-fade-in hover:scale-105" style={{
          animationDelay: `${index * 150}ms`
        }}>
              <CardContent className="p-8 text-center">
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl ${badge.bgColor} group-hover:scale-110 mb-6 transition-all duration-300 animate-bounce`} style={{
        ...
        <div className="bg-gradient-to-br from-yellow-500 to-orange-500 rounded-3xl p-12 shadow-2xl border-4 border-white animate-scale-in mb-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => <div key={index} className="group animate-fade-in hover:scale-110 transition-transform duration-300" style={{
            animationDelay: `${index * 200}ms`
          }}>
                <div className="flex items-center justify-center mb-4">
                  <stat.icon className="w-8 h-8 text-black mr-3 animate-bounce" style={{
                animationDelay: `${index * 150}ms`
              }} />
