      ...
      <div className="container mx-auto px-4 py-12 relative z-10 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-8 xl:gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-6 animate-fade-in order-2 lg:order-1">
            ...
            {/* Left-aligned supporting content for better readability */}
            <div className="text-left space-y-6">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 animate-fade-in delay-700">
              ...
              <div className="space-y-4 sm:space-y-6 animate-fade-in delay-1000">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-8 text-sm">
